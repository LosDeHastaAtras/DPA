...
URL_access_token <- "https://pubsbapi.smartbike.com/oauth/v2/token?client_id=577_4jumf047jam88ksscgkk84sgskwgws0w8ooo4gw84kswk4kokg&client_secret=1c6nfmvo702s008w0o8gw008k80c8cskogcs0w08s4k0wcokog&grant_type=client_credentials"

access_token_list <- fromJSON(RCurl::getURL(URL_access_token))

access_token <- access_token_list$access_token
refresh_token <- access_token_list$refresh_token
